...
class mqvqa:
    ...
    def train(self, data):
        ...
        answers, losses = self.build_model_label()
        ...
        for epoch in tqdm(range(start_epoch, self.config.epoches)):
            ...
            for batch in tqdm(range(batches)):
                ...
                _, result_ans, result_los = self.sess.run([train_op, answers, losses],
                                                                      feed_dict={
    ...
    def validation(self, data):
        ...
        for batch in tqdm(range(num_iters)):
            ...
            result_ans, _ = self.sess.run([answers, losses],
